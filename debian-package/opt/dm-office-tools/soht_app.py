...
ICON_PATH = "/usr/share/icons/hicolor/256x256/apps/dm-office-tools.png"

E2H_SCRIPT = os.path.join(INSTALL_DIR, "stable", "run_hindi.sh")
H2E_SCRIPT = os.path.join(INSTALL_DIR, "stable", "run_hindi_to_english.sh")
DICTIONARY_SCRIPT = os.path.join(
    INSTALL_DIR, "dictionary", "smart_dictionary_manager.py"
)
...
class SOHTApp(Gtk.Window):
    ...
    def __init__(self):
        Gtk.Window.__init__(self, title="DM Office Tools (SOHT)")
    ...
    def build_ui(self):
        ...
        title.set_markup(
            ...
            "DM Office Tools (SOHT)"
            "</span>"
        )
        main_box.pack_start(title, False, False, 0)

        subtitle = Gtk.Label(
            label="Smart Office Hybrid Translator"
        )
